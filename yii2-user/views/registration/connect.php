    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'user_type')->radioList($model::$usertype_list,
                    [
                        'item' => function ($index, $label, $name, $checked, $value) {
                            return
                                '<div class="col-sm-6 nopadding"><label>'.Html::radio($name, $checked, ['value' => $value]) . $label . '</label></div>';
                        },
                    ]
                );  ?>
                ...
                <?php //$form->field($model, 'user_type') ?>
