...
class Account extends ActiveRecord
{
    ...
    public function connect(User $user)
    {
        ...
        return $this->updateAttributes([
            'username' => null,
            'email'    => null, //$user->email, //$data->email
            'code'     => null,
            'user_id'  => $user->id,
        ]);
    }
    ...
    protected static function fetchUser(Account $account)
    {
        ...
        // We don't create a user in order to offer an user extended data fields like user_type, phone, etc. in Registration/Connect
        /*
